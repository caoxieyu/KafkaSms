...
import com.kafka.sms.biz.impl.GameMemberGroupServiceImpl;
import com.kafka.sms.entity.db.GameMemberGroup;
import com.kafka.sms.utils.DateUtil;
import com.kafka.sms.utils.JsonUtil;
import com.kafka.sms.utils.SpringApplicationContext;
...
import  com.kafka.sms.entity.enums.*;
...
public class ChatHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
	...
	protected void channelRead0(ChannelHandlerContext ctx, TextWebSocketFrame msg) 
		...
		if (action == MsgActionEnum.CONNECT.type) {
			...
			// 动态查询成员信息列表
			IGameMemberGroupService IGameMemberGroupService = (com.kafka.sms.biz.IGameMemberGroupService) SpringApplicationContext.getBean(GameMemberGroupServiceImpl.class);

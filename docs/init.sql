CREATE TABLE `tb_consumes` (
	`consume_id`  int NOT NULL AUTO_INCREMENT COMMENT '消费日志ID',
	`phone` varchar(11) NOT NULL COMMENT '手机号码',
	`type` int(11) NOT NULL COMMENT '运营商(0=移动,1=联通,2=电信,3=虚拟号码)',
	`add_date` datetime NOT NULL COMMENT '登记时间',
	`area_id` varchar(32) NOT NULL COMMENT '归属地',
	`content` varchar(255) DEFAULT NULL COMMENT '短信内容',
	`get_number_date`  datetime NOT NULL COMMENT '取号时间',
	`release_number_date`  datetime NOT NULL COMMENT '取号时间',
	PRIMARY KEY (`consume_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='客户消费日志表';



CREATE TABLE `tb_stock` (
  `stock_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '商品ID',
  `project_id` int(11) NOT NULL COMMENT '项目ID',
  `merchant_id` int(11) NOT NULL COMMENT '卖家ID',
  `memchant_name` varchar(255) NOT NULL COMMENT '商家名称',
  `phone` varchar(11) NOT NULL COMMENT '手机号码',
  `type` int(11) NOT NULL COMMENT '运营商(0=移动,1=联通,2=电信,3=虚拟号码)',
  `add_date` datetime NOT NULL COMMENT '登记时间',
  `area_id` varchar(32) NOT NULL COMMENT '归属地',
  `content` varchar(255) DEFAULT NULL COMMENT '短信内容',
  `status`  datetime NOT NULL COMMENT '号码状态(0=正常,1=已锁定)',
  PRIMARY KEY (`stock_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='手机号码库存表';


CREATE TABLE `tb_projects` (
  `project_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '项目ID',
  `project_name` varchar(255) NOT NULL COMMENT '项目名称',
  `expression_start` varchar(255) NOT NULL COMMENT '文本验证表达式开头',
  `expression_end` varchar(255) NOT NULL COMMENT '文本验证表达式结尾',
  `service_number` varchar(32) NOT NULL COMMENT '短信服务商号码',
  `status` int(11) NOT NULL COMMENT '项目状态码(0=正常,1=删除,2=定制通道)',
  `amount` decimal(14,4) NOT NULL COMMENT '售价',
  `cost` decimal(14,4) NOT NULL COMMENT '成本价',
  `app_key` varchar(255) DEFAULT NULL COMMENT '定制通道key',
  PRIMARY KEY (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='短信项目表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='行政地区编码表';


INSERT INTO `tb_areas` VALUES ('110000', '北京市', NULL);
INSERT INTO `tb_areas` VALUES ('110100', '市辖区', '110000');
...
INSERT INTO `tb_areas` VALUES ('120100', '市辖区', '120000');
...
INSERT INTO `tb_areas` VALUES ('150601', '市辖区', '150600');
...
INSERT INTO `tb_areas` VALUES ('310100', '市辖区', '310000');
...
INSERT INTO `tb_areas` VALUES ('500100', '市辖区', '500000');
...
INSERT INTO `tb_areas` VALUES ('520501', '市辖区', '520500');
...
INSERT INTO `tb_areas` VALUES ('520601', '市辖区', '520600');
...
INSERT INTO `tb_areas` VALUES ('540501', '市辖区', '540500');
